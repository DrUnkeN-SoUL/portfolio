export class Terminal {
  constructor() {
    ...
    this.sudoCommands = this.buildSudoCommands();
...
+========================================+
      ...
      geek: () => this.commands.hack(),
    };
  }

  buildSudoCommands() {
    return {
      // --- destroy: wipe the page with BIOS panic sequence ---
      'rm': () => {
    ...
    return {
      gravity: () => {
        if (window.zeroG && window.zeroG.active) {
          ...
          return `<span class="term-green">Gravity modules re-enabled. Layout floating restored.</span>`;
        }
        ...
        return `<span class="term-red">Gravity modules disabled. DVD mode active. Bounce off the edges! Type "gravity" to restore.</span>`;
      },
      ...
      rebuild: () => this.easterEggs.restore()
    };
  }
